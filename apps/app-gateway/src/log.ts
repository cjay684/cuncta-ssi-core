...
const SERVICE_NAME = "app-gateway";

const SENSITIVE_KEY =
  /secret|private|signature|payload|token|authorization|bearer|access[_-]?token|refresh[_-]?token|api[_-]?key|client[_-]?secret|secret[_-]?key|apikey|credential|presentation|did|claim/i;
