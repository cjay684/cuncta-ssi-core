...
const SENSITIVE_KEY =
  /secret|private|signature|payload|key|token|authorization|bearer|access[_-]?token|refresh[_-]?token|api[_-]?key|client[_-]?secret|secret[_-]?key|apikey|presentation/i;
